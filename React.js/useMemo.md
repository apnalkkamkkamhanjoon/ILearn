...
## useMemo 사용해보기
성능 최적화를 위하여 연산된 값을 `useMemo`라는 Hook 을 사용하여 재사용하는 방법을 알아보도록 하겠습니다.
...
코드를 수정했다면 다시 `input`을 써봐도 불필요한 렌더링이 일어나지 않을 것 입니다.